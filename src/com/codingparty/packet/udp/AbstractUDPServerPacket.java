...
public abstract class AbstractUDPServerPacket {
	...
	public AbstractUDPServerPacket(EnumUDPPacketType type) {
		packetType = type;
	...
	public boolean equals(Object other) {
		if (other == null || !(other instanceof AbstractUDPServerPacket)) return false;
		AbstractUDPServerPacket otherPacket = (AbstractUDPServerPacket) other;
